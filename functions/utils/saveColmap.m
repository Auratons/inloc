function saveColmap( directory, cameras, images, points3D )
    %SAVECOLMAP - save the colmap structures into the files
        ...
        write_cameras(fullfile(directory, 'cameras.txt'), cameras);
        write_images(fullfile(directory, 'images.txt'), images);
        write_points3D(fullfile(directory, 'points3D.txt'), points3D);
    end
